    ...
    >
      ...
      >
        ...
        <div className="grid grid-cols-3 gap-4 text-center">
          ...
          <div>
            <div className="text-lg font-bold text-gray-800">{stats.avgResponseTime.toFixed(1)}s</div>
            <div className="text-xs text-gray-600">Average Speed (20%)</div>
          </div>
          <div>
            <div className="text-lg font-bold text-purple-600">{stats.totalTime.toFixed(1)}s</div>
